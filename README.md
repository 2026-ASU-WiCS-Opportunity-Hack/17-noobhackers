...
- [Team Slack Channel](https://opportunity-hack.slack.com/app_redirect?channel=team-17-noobhackers)
...
```bash
# Example commands
git clone https://github.com/2026-ASU-WiCS-Opportunity-Hack/17-noobhackers.git
cd 17-noobhackers
