    ...
    <div className="flex min-h-[80vh] flex-col lg:flex-row">
      ...
      <div className="flex flex-1 items-center justify-center bg-wial-gray-50 px-6 py-16 lg:px-12">
        <div className="w-full max-w-sm">
          ...
          {error && (
            <div className="mt-4 rounded-lg border border-wial-error/30 bg-wial-error/5 px-4 py-3">
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex w-full items-center justify-center rounded-lg bg-wial-red px-4 py-3 text-sm font-semibold text-white hover:bg-wial-red-light disabled:opacity-60"
            >
              {submitting ? (
          ...
          <div className="mt-8 text-center">
            <Link href="/" className="text-sm text-wial-gray-500 hover:text-wial-red">
              ← Continue as Guest
            </Link>
          </div>
